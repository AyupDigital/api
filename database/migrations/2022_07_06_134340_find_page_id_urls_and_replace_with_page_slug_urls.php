...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Page::withoutGlobalScopes()->chunk(50, function ($pages) use ($host, $uuidRegex) {
        ...
        Service::withoutGlobalScopes()->chunk(50, function ($services) use ($host, $uuidRegex) {
        ...
        UsefulInfo::withoutGlobalScopes()->chunk(50, function ($usefulInfos) use ($host, $uuidRegex) {
